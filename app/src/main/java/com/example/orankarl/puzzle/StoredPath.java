...
public class StoredPath {
    ...
    public static final int flat_horizontal_x = 0, flat_horizontal_y = 1, flat_vertical_x = 2, flat_vertical_y = 3,
            classic_horizontal_x = 4, classic_horizontal_y = 5, classic_vertical_x = 6, classic_vertical_y = 7;
